...
///////////////////////////////////////////////////////////////////////
//
//  Log gamma function, based on gamma.h from NRC3
//
///////////////////////////////////////////////////////////////////////
...
void Params::set(const char *parameter_File, const char *mosquito_File[N_spec_max])
{
    ////////////////////////////////////////////
    //                                        //
    ...
    parameter_Stream >> discard >> BS_treat_cov_base >> discard;      // proportion of episodes of symptomatic disease treated (baseline)
    parameter_Stream >> discard >> BS_treat_eff_base >> discard;      // efficacy of front-line treatment (baseline)
    ...
    treat_cov = BS_treat_cov_base;                       // Treatment coverage
    treat_eff = BS_treat_eff_base;                       // Efficacy of treatment
    r_P = 1.0 / BS_treat_BSproph_base;                   // rate of recovery from prophylaxis

    PQ_treat_cover   = 0.0;
    PQ_treat_PQcover = 0.0;
    PQ_treat_BSeff   = 0.0;
    PQ_treat_PQeff   = 0.0;
